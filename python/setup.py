...
if platform == "win32":
    ...
    data_files = [('Lib/site-packages/maxent' ,
            ['libifcoremd.dll', 'libmmd.dll', 'stlport_vc7146.dll'])
          ]
    opt_lib = []
    opt_lib_path = []
    ...
    fclibs = " -L/home/s0450736/opt/lib -L/usr/local/lib -L/usr/X11R6/lib -L/usr/lib/gcc/i386-redhat-linux/4.1.1 -L/usr/lib/gcc/i386-redhat-linux/4.1.1/../../.. -lgfortranbegin -lgfortran -lm -lgcc_s"
